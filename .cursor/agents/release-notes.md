...
- **Text output only** in chat; do **not** write files (including `CHANGELOG.md`) unless the user explicitly asks to create/update a file in this turn.
- Do **not** run git. Respect `readonly: true`.
