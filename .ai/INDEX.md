...
- `test-verifier`
- `release-manager`
- `ci-monitor` (CI diagnostics and remediation policy)
...
- **CI monitoring:** [`.ai/skills/ci-monitor/SKILL.md`](skills/ci-monitor/SKILL.md) — classification, redaction, retries, and remediation gates
