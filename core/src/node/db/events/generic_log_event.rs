use crate::node::db::events::common::{LogEventKeyBasedRecord, MempoolObject, MetaPassObject, SecretShareObject};
...
impl LogEventKeyBasedRecord for GenericKvLogEvent {
    fn key(&self) -> &KvKey {
        match self {
            ...
            GenericKvLogEvent::SecretShare(obj) => obj.key(),
